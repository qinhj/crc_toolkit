...
int main() {
    ...
    printf("Parameters:\n");
    printf("\n");
    printf(" polynom             :  0x%lx\n", polynom);
    printf(" order               :  %d\n", order);
    printf(" crcinit             :  0x%lx direct, 0x%lx nondirect\n", crcinit_direct, crcinit_nondirect);
    printf(" crcxor              :  0x%lx\n", crcxor);
    printf(" refin               :  %d\n", refin);
    printf(" refout              :  %d\n", refout);
    printf("\n");
